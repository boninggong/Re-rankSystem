...
# Opposite re-rank algorithm uses global mapping in this class
    ...
    for rerank_size in sub_rerank_sizes:
        ...
        if metric_to_use == 'Prec':
            final = {'lambda': [], f'{metric_to_use}_{metrics_sizes[0]}_initial': [],
                     ...
                     f'{metric_to_use}_{metrics_sizes[1]}_initial': [],
                     f'{metric_to_use}_{metrics_sizes[1]}_rerank': []}
        else:
            final = {'lambda': [], f'{metric_to_use}_{metrics_sizes[0]}_initial': [],
                     f'{metric_to_use}_{metrics_sizes[0]}_rerank': [],
                     f'{metric_to_use}_{metrics_sizes[1]}_initial': [],
                     f'{metric_to_use}_{metrics_sizes[1]}_rerank': [],
                     f'{metric_to_use}_{metrics_sizes[2]}_initial': [],
                     f'{metric_to_use}_{metrics_sizes[2]}_rerank': []}
